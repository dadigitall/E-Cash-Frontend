...
export default function AddRequesterModal({
    isOpen,
    onClose,
    onSuccess,
}) {
    ...
    async function fetchFormData() {
        ...
        try {
            const [postesResponse, entreprisesResponse] =
                await Promise.all([
                    api.get("/postes"),
                    api.get("/entreprises"),
                ]);
            ...
            const entreprisesData = Array.isArray(
            ...
            console.error(
                "Erreur chargement formulaire demandeur :",
                err
            );
            ...
            setError(
                "Impossible de charger les postes et les entreprises."
            );
        } finally {
    ...
    async function handleSubmit(e) {
        ...
        try {
            ...
            if (err.response?.status === 422) {
                ...
                setError(
                    err.response?.data?.message ||
                    "Impossible de créer le demandeur."
                );
            }
        } finally {
            setLoading(false);
                ...
                <div className="flex items-center justify-between mb-6">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-gray-500 mt-1">
                            ...
                            l'employé définisse son mot de passe.
                        </p>
                    </div>
